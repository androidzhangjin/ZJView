...
public class ZJViewRenderProxy {
    ...
    ZJViewRenderProxy(View view, Context context, AttributeSet attrs, int defStyleAttr) {
        mView = view;
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ZJRelativeLayout, defStyleAttr, 0);
        mRadius = typedArray.getDimension(R.styleable.ZJRelativeLayout_radius, 0);
        mCornerRadii[0] = mCornerRadii[1] = typedArray.getDimension(R.styleable.ZJRelativeLayout_left_top_radius, 0);
        mCornerRadii[2] = mCornerRadii[3] = typedArray.getDimension(R.styleable.ZJRelativeLayout_right_top_radius, 0);
        mCornerRadii[4] = mCornerRadii[5] = typedArray.getDimension(R.styleable.ZJRelativeLayout_right_bottom_radius, 0);
        mCornerRadii[6] = mCornerRadii[7] = typedArray.getDimension(R.styleable.ZJRelativeLayout_left_bottom_radius, 0);
        mBorder = typedArray.getDimension(R.styleable.ZJRelativeLayout_border, 0);
        mBackgroundColor = typedArray.getColor(R.styleable.ZJRelativeLayout_backgroundColor, 0);
        mBorderColor = typedArray.getColor(R.styleable.ZJRelativeLayout_borderColor, 0);
        int direction = typedArray.getInt(R.styleable.ZJRelativeLayout_arrowDirection, 3);
        mRelativePosition = typedArray.getFraction(R.styleable.ZJRelativeLayout_relativePosition, 1, 1, 0.5f);
        mSharpSize = typedArray.getDimension(R.styleable.ZJRelativeLayout_sharpSize, 0);

        gradientOrientation = typedArray.getInt(R.styleable.ZJRelativeLayout_gradient_orientation, 6);
        switch (direction) {
            case 1:
        ...
        int start = typedArray.getColor(R.styleable.ZJRelativeLayout_startBgColor, -1);
        int middle = typedArray.getColor(R.styleable.ZJRelativeLayout_middleBgColor, -1);
        int end = typedArray.getColor(R.styleable.ZJRelativeLayout_endBgColor, -1);
        if (start != -1 && end != -1) {
            if (middle != -1) {
