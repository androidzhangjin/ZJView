...
class ZJDrawable extends GradientDrawable {


    ZJDrawable(Orientation orientation, @ColorInt int[] colors) {
    ...
    void setArrowDirection(ZJView.ArrowDirection arrowDirection) {
    ...
    private ZJView.ArrowDirection mArrowDirection;
